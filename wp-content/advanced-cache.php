...
$possible_plugin_locations = array(
	...
	'/Users/harbi/Sites/localhost/wordpress/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost:8888/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/Users/harbi/Sites/localhost/wordpress/wp-content/plugins/wp-optimize/cache/extensions');
}
